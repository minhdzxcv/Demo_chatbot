...
loader_csv = CSVLoader(
    file_path = r'C:\Users\MINH\Downloads\AI-main\AI-main\mobi.csv',
    encoding='utf-8'
)
urls = [
    'https://mobigames.vn/',
...
loader_pdf = PyPDFLoader(
    file_path= r'C:\Users\MINH\Downloads\AI-main\AI-main\mobicloud.pdf'
)
...
# Nhập API key
os.environ["TOGETHER_API_KEY"] = '1a793227b79c2dc0ac84b37f68c6638fa9e0f3ba877b96605e52f30c6119582a'
...
conn = psycopg2.connect(
    dbname="AI", user="postgres", password="admin", host="localhost", port="5432"
)
cursor = conn.cursor()
